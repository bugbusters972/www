...
<tr class="row-category">
	...
	<td width="7%"><?php echo lang_get( 'plugin_priorite' ) ?></td>
...
foreach ( $t_plugins_installed as $t_basename => $t_plugin ) {
	...
	$t_depends = array();
	$t_motif_contact = plugin_priorite( $t_basename );
	...
	if ( 'MantisCore' != $t_basename ) {
		echo '<td class="center">','<select name="motif_contact_',$t_basename,'">',print_plugin_priorite_list( $t_motif_contact ),'</select>','</td>';
...
<tr>
	...
	<td colspan="2" class="center">
		<input type="submit" class="" value="<?php echo lang_get( 'plugin_update' ) ?>"/>
	</td>
	<td></td>
</tr>
