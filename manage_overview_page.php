...
<td class="description"><?php echo lang_get( 'mantis_version' ) ?></td>
<td><?php echo MANTIS_VERSION, ( $t_version_suffix ? " $t_version_suffix" : '' ) ?></td>
</tr>

<tr <?php echo helper_alternate_class() ?>>
<td class="description"><?php echo lang_get( 'schema_version' ) ?></td>
...
?>
<tr <?php echo helper_alternate_class() ?>>
<td class="description"><?php echo lang_get( 'site_path' ) ?></td>
<td><?php echo config_get( 'absolute_path' ) ?></td>
</tr>

<tr <?php echo helper_alternate_class() ?>>
<td class="description"><?php echo lang_get( 'core_path' ) ?></td>
<td><?php echo config_get( 'core_path' ) ?></td>
</tr>

<tr <?php echo helper_alternate_class() ?>>
<td class="description"><?php echo lang_get( 'plugin_path' ) ?></td>
