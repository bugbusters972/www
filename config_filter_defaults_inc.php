...
#  If not, see <http://www.gnu.org/licenses/>.
	...
	*
    ...
    define( 'FILTER_PROPERTY_sexe_ID', 'show_sexe' );
    define( 'FILTER_PROPERTY_STATUS_ID', 'show_status' );
    define( 'FILTER_PROPERTY_motif_nvvenue_ID', 'show_motif_nvvenue' );
    ...
    define( 'FILTER_PROPERTY_nomepouse', 'nomepouse' );
    define( 'FILTER_PROPERTY_nom', 'nom' );
    define( 'FILTER_PROPERTY_prenom', 'prenom' );
    define( 'FILTER_PROPERTY_telephone', 'telephone' );
    ...
    define( 'FILTER_SEARCH_sexe_ID', 'sexe_id');
    ...
    define( 'FILTER_SEARCH_motif_nvvenue_ID', 'motif_nvvenue_id' );
    define( 'FILTER_SEARCH_PROFILE', 'profile_id' );
    define( 'FILTER_SEARCH_nom', 'nom' );
    define( 'FILTER_SEARCH_nomepouse', 'nomepouse' );
    define( 'FILTER_SEARCH_prenom', 'prenom' );
    define( 'FILTER_SEARCH_telephone', 'telephone' );
