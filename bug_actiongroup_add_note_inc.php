...
#  If not, see <http://www.gnu.org/licenses/>.
	...
	*
	...
	function action_add_note_print_fields() {
		echo '<tr class="row-1" valign="top"><td class="description">', lang_get( 'add_bugnote_title' ), '</td><td><textarea name="bugnote_text" cols="72" rows="10"></textarea></td></tr>';
	?>
	<!-- View Status -->
	<tr class="row-2">
...
?>
	...
	<?php
		echo '<tr><td colspan="2"><center><input type="submit"  value="' . lang_get( 'add_bugnote_button' ) . ' " /></center></td></tr>';
	}
