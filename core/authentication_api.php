...
function estconnecte( $p_return_page = '' ) {
	# if logged in
	if( auth_is_user_authenticated() ) {
		# check for access enabled
		#  This also makes sure the cookie is valid
...
$p_return_page = string_url( $p_return_page );
print_header_redirect( 'login_page_pointeuse.php?return=' . $p_return_page );
}
}
