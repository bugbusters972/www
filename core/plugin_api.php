 ...
 */
function plugin_priorite( $p_basename ) {
	global $g_plugin_cache_priorite;
	...
	return $g_plugin_cache_priorite[$p_basename];
}
...
function plugin_register_installed() {
	global $g_plugin_cache_priorite, $g_plugin_cache_protected;
	...
	while( $t_row = db_fetch_array( $t_result ) ) {
		...
		$g_plugin_cache_priorite[$t_basename] = $t_row['priority'];
...
function plugin_init_installed() {
	...
	global $g_plugin_cache, $g_plugin_current, $g_plugin_cache_priorite, $g_plugin_cache_protected, $g_plugin_cache_init;
	$g_plugin_cache = array();
	$g_plugin_current = array();
