...
function columns_get_standard( $p_enabled_columns_only = true ) {
	...
	if( $p_enabled_columns_only && OFF == config_get( 'enable_profiles' ) ) {
		unset( $t_columns['prenom'] );
		unset( $t_columns['telephone'] );
		unset( $t_columns['nom'] );
		unset( $t_columns['nomepouse'] );
	}
 ...
 * @access public
 */
function print_column_title_motif_contact( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'motif_contact_abbreviation' ), 'motif_contact', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'motif_contact' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_type_contact( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'type_contact' ), 'type_contact', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'type_contact' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_prenom( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'prenom' ), 'prenom', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'prenom' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_telephone( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'prenom' ), 'telephone', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'telephone' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_nom( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'nom' ), 'nom', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'nom' );
	echo '</td>';
}

function print_column_title_nomepouse( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'nomepouse' ), 'nomepouse', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'nomepouse' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_sexe( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	print_view_bug_sort_link( lang_get( 'sexe' ), 'sexe', $p_sort, $p_dir, $p_columns_target );
	print_sort_icon( $p_dir, $p_sort, 'sexe' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_motif_nvvenue( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	echo lang_get( 'motif_nvvenue' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_title_date_nvvenue( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	echo lang_get( 'date_nvvenue' );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_motif_contact( $p_bug, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td>';
	if( ON == config_get( 'show_motif_contact_text' ) ) {
		print_formatted_motif_contact_string( $p_bug );
	} else {
		print_status_icon( $p_bug->motif_contact );
	}
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_sexe( $p_bug, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td class="center">';
	print_formatted_sexe_string( $p_bug );
	echo '</td>';
}
 ...
 * @access public
 */
function print_column_type_contact( $p_bug, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<td class="center">', get_enum_element( 'type_contact', $p_bug->type_contact, auth_get_current_user_id(), $p_bug->project_id ), '</td>';
}
 ...
 * @access public
 */
function print_column_motif_nvvenue( $p_bug, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	$t_motif_nvvenue = string_display_links( $p_bug->motif_nvvenue );

	echo '<td class="left">', $t_motif_nvvenue, '</td>';
}
 ...
 * @access public
 */
function print_column_date_nvvenue( $p_bug, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	$t_date_nvvenue = string_display_links( $p_bug->date_nvvenue );

	echo '<td class="left">', $t_date_nvvenue, '</td>';
}
