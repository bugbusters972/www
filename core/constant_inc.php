...
# type_contact
define( 'type_contact_ALWAYS', 10 );
define( 'type_contact_SOMETIMES', 30 );
define( 'type_contact_RANDOM', 50 );
define( 'type_contact_HAVENOTTRIED', 70 );
define( 'type_contact_UNABLETODUPLICATE', 90 );
define( 'type_contact_NOTAPPLICABLE', 100 );
...
define( 'REV_MOTIF_NVVENUE', 2 );
define( 'REV_DATE_NVVENUE', 3 );
