...
<?php
	...
	if( !bug_is_readonly( $p_bug_id ) ) {
		...
		if( access_has_bug_level( config_get( 'update_bug_threshold' ), $p_bug_id ) ) {
			?>
<tr class="row-1">
	<td class="description"><?php echo lang_get( 'add_new_relationship' )?></td>
	<td><?php echo lang_get( 'this_bug' )?>
		...
		<input type="submit" name="add_relationship"  value="<?php echo lang_get( 'add_new_relationship_button' )?>" />
		</form>
	</td></tr>
<?php
		}
