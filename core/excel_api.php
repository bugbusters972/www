...
/**
 * Gets the formatted motif_contact.
 * @param object $p_bug the bug
 * @returns the motif_contact text.
 */
function excel_format_motif_contact( $p_bug ) {
	return excel_prepare_string( get_enum_element( 'motif_nvvenue', $p_bug->motif_nvvenue, auth_get_current_user_id(), $p_bug->project_id ) );
}

/**
 * Gets the formatted sexe.
 * @param object $p_bug the bug
 * @returns the sexe text.
 */
function excel_format_sexe( $p_bug ) {
	return excel_prepare_string( get_enum_element( 'sexe', $p_bug->sexe, auth_get_current_user_id(), $p_bug->project_id ) );
}

/**
 * Gets the formatted type_contact.
 * @param object $p_bug the bug
 * @returns the type_contact text.
 */
function excel_format_type_contact( $p_bug ) {
	return excel_prepare_string( get_enum_element( 'type_contact', $p_bug->type_contact, auth_get_current_user_id(), $p_bug->project_id ) );
}
 ...
 */
function excel_format_prenom( $p_bug ) {
	return excel_prepare_string( $p_bug->prenom );
}
 ...
 */
function excel_format_telephone( $p_bug ) {
	return excel_prepare_string( $p_bug->telephone );
}
...
/**
 * Gets the formatted nom,
 * @param object $p_bug the bug
 * @returns the nom.
 */
function excel_format_nom( $p_bug ) {
	return excel_prepare_string( $p_bug->nom );
}

function excel_format_nomepouse( $p_bug ) {
	return excel_prepare_string( $p_bug->nomepouse );
}
 ...
 */
function excel_format_motif_nvvenue( $p_bug ) {
	return excel_prepare_string( $p_bug->motif_nvvenue );
}
 ...
 */
function excel_format_date_nvvenue( $p_bug ) {
	return excel_prepare_string( $p_bug->date_nvvenue );
}
