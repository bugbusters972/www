...
<tr>
	<td class="left" colspan="3">
		<form method="post" action="manage_proj_ver_add.php">
			...
			<input type="submit" name="add_version"  value="<?php echo lang_get( 'add_version_button' ) ?>" />
			<input type="submit" name="add_and_edit_version"  value="<?php echo lang_get( 'add_and_edit_version_button' ) ?>" />
		</form>
	</td>
</tr>
<tr>
	<td class="left" colspan="3">
		<form method="post" action="manage_proj_ver_copy.php">
			...
			<input type="submit" name="copy_from"  value="<?php echo lang_get( 'copy_versions_from' ) ?>" />
			<input type="submit" name="copy_to"  value="<?php echo lang_get( 'copy_versions_to' ) ?>" />
		</form>
	</td>
</tr>
</table>
	...
	<tr>
		<td class="left" colspan="3">
			<form method="post" action="manage_proj_custom_field_copy.php">
				...
				<input type="submit" name="copy_from"  value="<?php echo lang_get( 'copy_from' ) ?>" />
				<input type="submit" name="copy_to"  value="<?php echo lang_get( 'copy_to' ) ?>" />
			</form>
		</td>
	</tr>
	</table>
		...
		<form method="post" action="manage_proj_user_copy.php">
			...
			<tr>
				<td class="left" colspan="3">
						...
						<input type="submit" name="copy_from"  value="<?php echo lang_get( 'copy_users_from' ) ?>" />
						<input type="submit" name="copy_to"  value="<?php echo lang_get( 'copy_users_to' ) ?>" />
				</td>
			</tr>
		</form>
	</table>
