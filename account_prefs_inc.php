...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_new_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_new_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_assigned_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_assigned_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_feedback_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_feedback_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_resolved_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_resolved_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_closed_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_closed_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_reopened_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_reopened_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_bugnote_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_bugnote_min_sexe ) ?>
		</select>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		...
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_status_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_status_min_sexe ) ?>
		</select>
	</td>
</tr>
<!--<tr <?php /*echo helper_alternate_class() ?>>
	<td class="description">
		<?php echo lang_get( 'email_on_motif_contact_change' ) ?>
	</td>
	<td>
		<input type="checkbox" name="email_on_motif_contact" <?php check_checked( $t_pref->email_on_motif_contact , ON); ?> />
		<?php echo lang_get( 'with_minimum_sexe' ) ?>
		<select name="email_on_motif_contact_min_sexe">
			<option value="<?php echo OFF ?>"><?php echo lang_get( 'any' ) ?></option>
			<option disabled="disabled">-----</option>
			<?php print_enum_string_option_list( 'sexe', $t_pref->email_on_motif_contact_min_sexe ) */?>
		</select>
	</td>
</tr>-->
<tr <?php echo helper_alternate_class() ?>>
...
<?php } else { ?>
		...
		<!--<input type="hidden" name="email_on_motif_contact" value="<?php echo $t_pref->email_on_motif_contact ?>" />-->
		<input type="hidden" name="email_on_new_min_sexe"      value="<?php echo $t_pref->email_on_new_min_sexe ?>" />
		<input type="hidden" name="email_on_assigned_min_sexe" value="<?php echo $t_pref->email_on_assigned_min_sexe ?>" />
		<input type="hidden" name="email_on_feedback_min_sexe" value="<?php echo $t_pref->email_on_feedback_min_sexe ?>" />
		<input type="hidden" name="email_on_resolved_min_sexe" value="<?php echo $t_pref->email_on_resolved_min_sexe ?>" />
		<input type="hidden" name="email_on_closed_min_sexe"   value="<?php echo $t_pref->email_on_closed_min_sexe ?>" />
		<input type="hidden" name="email_on_reopened_min_sexe" value="<?php echo $t_pref->email_on_reopened_min_sexe ?>" />
		<input type="hidden" name="email_on_bugnote_min_sexe"  value="<?php echo $t_pref->email_on_bugnote_min_sexe ?>" />
		<input type="hidden" name="email_on_status_min_sexe"   value="<?php echo $t_pref->email_on_status_min_sexe ?>" />
		<!--<input type="hidden" name="email_on_motif_contact_min_sexe" value="<?php echo $t_pref->email_on_motif_contact_min_sexe ?>" />-->
