<?php
	...
	switch ( $f_action )  {
		...
		case 'UP_PRIOR' :
			$t_question_title 		= lang_get( 'motif_contact_bugs_conf_msg' );
			$t_button_title 		= lang_get( 'motif_contact_group_bugs_button' );
			$t_form 				= 'motif_contact';
			break;
		...
		if ( $f_action === 'CUSTOM' ) {
			...
			switch ( $f_action ) {
				...
				case 'RESOLVE':
					...
					break;
				case 'UP_PRIOR':
					print_enum_string_option_list( 'motif_contact', config_get( 'default_bug_motif_contact' ) );
					break;
				case 'UP_STATUS':
...
<tr class="row-1">
	...
	<td>
		<textarea name="bugnote_text" cols="72" rows="10"></textarea>
	</td>
</tr>
