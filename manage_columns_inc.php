...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<textarea <?php echo helper_get_tab_index() ?> name="all_columns" readonly="readonly" cols="72" rows="5"><?php echo $t_all ?></textarea>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<textarea <?php echo helper_get_tab_index() ?> name="view_issues_columns" cols="72" rows="5"><?php echo $t_view_issues ?></textarea>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<textarea <?php echo helper_get_tab_index() ?> name="print_issues_columns" cols="72" rows="5"><?php echo $t_print_issues ?></textarea>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<textarea <?php echo helper_get_tab_index() ?> name="csv_columns" cols="72" rows="5"><?php echo $t_csv ?></textarea>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<textarea <?php echo helper_get_tab_index() ?> name="excel_columns" cols="72" rows="5"><?php echo $t_excel ?></textarea>
	</td>
</tr>
...
<tr>
	...
	<td class="center">
		...
		<input <?php echo helper_get_tab_index() ?> type="submit"  name="update_columns_as_my_default" value="<?php echo lang_get( 'update_columns_as_my_default' ) ?>" />
		<?php } else { ?>
		<input <?php echo helper_get_tab_index() ?> type="submit"  name="update_columns_for_current_project" value="<?php echo lang_get( 'update_columns_for_current_project' ) ?>" />
		<?php } } ?>
<?php if ( $t_manage_page && current_user_is_administrator() ) { ?>
		<input <?php echo helper_get_tab_index() ?> type="submit" name="update_columns_as_global_default" value="<?php echo lang_get( 'update_columns_as_global_default' ) ?>" />
<?php } ?>
	</td>
</tr>
...
?>
			<input type="submit" name="copy_from" class="" value="<?php echo lang_get( 'copy_columns_from' ) ?>" />
<?php
		}
?>
			<input type="submit" name="copy_to" class="" value="<?php echo lang_get( 'copy_columns_to' ) ?>" />
	</td>
</tr>
</table>
</form>
...
<!-- Reset Button -->
	<form method="post" action="manage_config_columns_reset.php">
		...
		<input type="submit" class="" value="<?php echo lang_get( 'reset_columns_configuration' ) ?>" />
	</form>
</div>
<?php
	}
