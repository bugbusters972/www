...
#  If not, see <http://www.gnu.org/licenses/>.
	...
	*
	...
	gpc_make_array( FILTER_SEARCH_sexe_ID );
	...
	gpc_make_array( FILTER_SEARCH_nomepouse );
	gpc_make_array( FILTER_SEARCH_nom );
	gpc_make_array( FILTER_SEARCH_prenom );
	gpc_make_array( FILTER_SEARCH_telephone );
	gpc_make_array( FILTER_SEARCH_motif_contact_ID );
	...
	$my_filter[FILTER_PROPERTY_sexe_ID] = gpc_get_string_array( FILTER_SEARCH_sexe_ID, META_FILTER_ANY );
	...
	$my_filter[FILTER_PROPERTY_motif_contact_ID] = gpc_get_string_array( FILTER_SEARCH_motif_contact_ID, META_FILTER_ANY );
	...
	$my_filter[FILTER_PROPERTY_nom] = gpc_get_string_array( FILTER_SEARCH_nom, META_FILTER_ANY );
	$my_filter[FILTER_PROPERTY_nom] = gpc_get_string_array( FILTER_SEARCH_nomepouse, META_FILTER_ANY );
	$my_filter[FILTER_PROPERTY_prenom] = gpc_get_string_array( FILTER_SEARCH_prenom, META_FILTER_ANY );
	$my_filter[FILTER_PROPERTY_telephone] = gpc_get_string_array( FILTER_SEARCH_telephone, META_FILTER_ANY );
