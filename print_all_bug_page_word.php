...
<?php
	...
	$t_lang_sexe = lang_get( 'sexe' );
	$t_lang_type_contact = lang_get( 'type_contact' );
	...
	$t_lang_nom = lang_get( 'nom' );
	$t_lang_nomepouse = lang_get( 'nomepouse' );
	$t_lang_due_date = lang_get( 'due_date' );
	$t_lang_prenom = lang_get( 'prenom' );
	$t_lang_telephone = lang_get( 'telephone' );
	$t_lang_fixed_in_version = lang_get( 'fixed_in_version' );
	$t_lang_resolution = lang_get( 'resolution' );
	$t_lang_priorite = lang_get( 'motif_contact' );
	...
	$t_lang_motif_nvvenue = lang_get( 'motif_nvvenue' );
	$t_lang_date_nvvenue = lang_get( 'date_nvvenue' );
...
<tr class="print-category">
	...
	<td class="print" width="16%">
		<?php echo $t_lang_sexe ?>:
	</td>
	<td class="print" width="16%">
		<?php echo $t_lang_type_contact ?>:
	</td>
	<td class="print" width="16%">
...
<tr class="print">
	...
	<td class="print">
		<?php echo get_enum_element( 'sexe', $t_bug->sexe, auth_get_current_user_id(), $t_bug->project_id ) ?>
	</td>
	<td class="print">
		<?php echo get_enum_element( 'type_contact', $t_bug->type_contact, auth_get_current_user_id(), $t_bug->project_id ) ?>
	</td>
	<td class="print">
...
<tr class="print">
	...
	<td class="print-category">
		<?php echo $t_lang_nomepouse ?>:
	</td>
	<td class="print">
		<?php echo string_display_line( $t_bug->nom ) ?>
	</td>
	<td class="print">
		<?php echo string_display_line( $t_bug->nomepouse ) ?>
	</td>
...
<tr class="print">
	...
	<td class="print-category">
		<?php echo $t_lang_prenom ?>:
	</td>
	<td class="print">
		<?php echo string_display_line( $t_bug->prenom ) ?>
	</td>
	<td class="print" colspan="2">&#160;</td>
</tr>
<tr class="print">
	<td class="print-category">
		<?php echo $t_lang_priorite ?>:
	</td>
	<td class="print">
		<?php echo get_enum_element( 'motif_nvvenue', $t_bug->motif_nvvenue, auth_get_current_user_id(), $t_bug->project_id ) ?>
	</td>
	<td class="print-category">
		<?php echo $t_lang_telephone ?>:
	</td>
	<td class="print">
		<?php echo string_display_line( $t_bug->telephone ) ?>
	</td>
	<td class="print" colspan="2">&#160;</td>
</tr>
<tr class="print">
...
<tr class="print">
	<td class="print-category">
		<?php echo $t_lang_motif_nvvenue ?>:
	</td>
	<td class="print" colspan="5">
		<?php echo string_display_links( $t_bug->motif_nvvenue ) ?>
	</td>
</tr>
<tr class="print">
	<td class="print-category">
		<?php echo $t_lang_date_nvvenue ?>:
	</td>
	<td class="print" colspan="5">
		<?php echo string_display_links( $t_bug->date_nvvenue ) ?>
	</td>
</tr>
<?php
