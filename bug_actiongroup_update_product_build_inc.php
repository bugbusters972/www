...
#  If not, see <http://www.gnu.org/licenses/>.
	...
	*
	...
	function action_update_product_build_print_fields() {
		echo '<tr class="row-1" valign="top"><td class="description">', lang_get( 'product_build' ), '</td><td><input type="text" name="build" size="32" maxlength="32" /></td></tr>';
		echo '<tr><td colspan="2"><center><input type="submit"  value="' . lang_get( 'actiongroup_menu_update_product_build' ) . ' " /></center></td></tr>';
	}
