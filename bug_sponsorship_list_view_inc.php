...
?>
	<tr class="row-1">
		<td class="description" width="15%"><?php echo lang_get( 'sponsor_issue' ) ?></td>
		<td>
			<form method="post" action="bug_set_sponsorship.php">
				...
				<input type="submit"  name="sponsor" value="<?php echo lang_get( 'sponsor_verb' ) ?>" />
			</form>
		</td>
	</tr>
<?php
...
?>
	<tr class="row-2">
		<td class="description" width="15%"><?php echo lang_get( 'sponsors_list' ) ?></td>
		<td>
		<?php
