...
#  If not, see <http://www.gnu.org/licenses/>.
	...
	*
	...
	#$t_prefs->email_on_motif_contact	= gpc_get_bool( 'email_on_motif_contact' );
	$t_prefs->email_on_new_min_sexe			= gpc_get_int( 'email_on_new_min_sexe' );
	$t_prefs->email_on_assigned_min_sexe	= gpc_get_int( 'email_on_assigned_min_sexe' );
	$t_prefs->email_on_feedback_min_sexe	= gpc_get_int( 'email_on_feedback_min_sexe' );
	$t_prefs->email_on_resolved_min_sexe	= gpc_get_int( 'email_on_resolved_min_sexe' );
	$t_prefs->email_on_closed_min_sexe		= gpc_get_int( 'email_on_closed_min_sexe' );
	$t_prefs->email_on_reopened_min_sexe	= gpc_get_int( 'email_on_reopened_min_sexe' );
	$t_prefs->email_on_bugnote_min_sexe		= gpc_get_int( 'email_on_bugnote_min_sexe' );
	$t_prefs->email_on_status_min_sexe		= gpc_get_int( 'email_on_status_min_sexe' );
	#$t_prefs->email_on_motif_contact_min_sexe	= gpc_get_int( 'email_on_motif_contact_min_sexe' );
