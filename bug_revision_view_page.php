...
function show_revision( $t_revision ) {
	...
	case REV_DESCRIPTION:
		...
		break;
	case REV_DATE_NVVENUE:
		$t_label = lang_get( 'motif_nvvenue' );
		break;
	case REV_DATE_NVVENUE:
		$t_label = lang_get( 'date_nvvenue' );
		break;
...
<td class="description"><?php echo lang_get( 'revision' ) ?></td>
...
<tr <?php echo helper_alternate_class() ?>>
<td class="description"><?php echo $t_label ?></td>
...
<tr <?php echo helper_alternate_class() ?>>
<td class="description" width="15%"><?php echo lang_get( 'summary' ) ?></td>
