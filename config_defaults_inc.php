<?php
	 ...
	 */
	$g_manual_url = '/docs/master-1.2.x/';
	...
	/**
	 * If use_x_motif_contact is set to ON, what should the value be?
	 * Urgent = 1, Not Urgent = 5, Disable = 0
	 * Note: some MTAs interpret X-motif_contact = 0 to mean 'Very Urgent'
	 * @global int $g_mail_priorite
	 */
	$g_mail_priorite		= 3;
	...
	/**
	 * show motif_contact as icon
	 * OFF: Shows motif_contact as icon in view all bugs page
	 * ON:  Shows motif_contact as text in view all bugs page
	 * @global int $g_show_motif_contact_text
	 */
	$g_show_motif_nvvenue_text	= OFF;

	/**
	 * Define the priorite level at which a bug becomes significant.
	 * Significant bugs are displayed with emphasis. Set this value to -1 to
	 * disable the feature.
	 * @global int $g_priorite_significant_threshold
	 */
	$g_priorite_significant_threshold = HIGH;

	/**
	 * Define the sexe level at which a bug becomes significant.
	 * Significant bugs are displayed with emphasis. Set this value to -1 to
	 * disable the feature.
	 * @global int $g_sexe_significant_threshold
	 */
	$g_sexe_significant_threshold = MAJOR;
	 ...
	 * id, project_id, reporter_id, handler_id, duplicate_id, motif_contact, sexe,
	 * type_contact, status, resolution, category_id, date_submitted, last_updated,
	 * os, telephone, nom, version, fixed_in_version, target_version, view_state,
	 * summary, sponsorship_total, due_date, description, motif_nvvenue,
	 * datenvvvenue, attachment_count, bugnotes_count, selection, edit,
	 * overdue
	 *
	 * @global array $g_view_issues_page_columns
	 */
	$g_view_issues_page_columns = array ( 'selection', 'edit', 'id', 'sponsorship_total', 'bugnotes_count', 'attachment_count', 'category_id', 'sexe', 'status', 'last_updated', 'summary' );
	 ...
	 */
	$g_print_issues_page_columns = array ( 'selection', 'id', 'bugnotes_count', 'attachment_count', 'sexe', 'last_updated' );
	 ...
	 */
	$g_csv_columns = array ( 'id', 'project_id', 'reporter_id', 'handler_id', 'sexe', 'type_contact', 'version', 'projection', 'category_id', 'date_submitted', 'eta', 'prenom', 'telephone', 'nom', 'last_updated', 'summary', 'status', 'resolution', 'fixed_in_version' );
	 ...
	 */
	$g_excel_columns = array ( 'id', 'project_id', 'reporter_id', 'handler_id', 'motif_contact', 'sexe', 'type_contact', 'version', 'projection', 'category_id', 'date_submitted', 'eta', 'prenom', 'telephone', 'nom', 'last_updated', 'summary', 'status', 'resolution', 'fixed_in_version' );
	 ...
	 * @global string $g_default_bug_date_nvvenue
	 */
	$g_default_bug_motif_nvvenue = '';

	/**
	 * Default value for addition information field.
	 * @global string $g_default_bug_date_nvvenue
	 */
	$g_default_bug_date_nvvenue = '';
	...
	/**
	 * Default bug sexe when reporting a new bug
	 * @global int $g_default_bug_sexe
	 */
	$g_default_bug_sexe = MINOR;

	/**
	 * Default bug motif_contact when reporting a new bug
	 * @global int $g_default_bug_motif_contact
	 */
	$g_default_bug_motif_nvvenue = NORMAL;

	/**
	 * Default bug type_contact when reporting a new bug
	 * @global int $g_default_bug_type_contact
	 */
	$g_default_bug_type_contact = type_contact_HAVENOTTRIED;
...
#default bug pour les nouveaux champs
...
$g_default_bug_ville ='';
$g_default_bug_region ='';
$g_default_bug_code_postal ='';
$g_default_bug_pays ='';
$g_default_bug_autre_hebergt ='';
$g_default_bug_email ='';
$g_default_bug_tel_domicile ='';
$g_default_bug_tel_travail ='';
$g_default_bug_orig_orient ='';
$g_default_bug_connu_assoc ='';
$g_default_bug_nom_logem ='';
$g_default_bug_type_logem ='';
$g_default_bug_complem_info ='';
$g_default_bug_matrim_ant ='';
$g_default_bug_matrim ='';
$g_default_bug_nb_enfant ='';
$g_default_bug_nb_enf_charge ='';
$g_default_bug_sxage_enf ='';
$g_default_bug_enf_pere ='';
$g_default_bug_enf_recon ='';
...
$g_default_bug_type_ent ='';
$g_default_bug_csp ='';
$g_default_bug_ressources ='';
$g_default_bug_prestations ='';
$g_default_bug_mere_victime='';
$g_default_bug_plaintes ='';
$g_default_bug_nb_plaintes='';
$g_default_bug_nb_plaintesko='';
$g_default_bug_plaintes_gend='';
$g_default_bug_nb_plaintesgend='';
$g_default_bug_nb_plainteskogend='';
$g_default_bug_maincour='';
$g_default_bug_nb_maincour='';
$g_default_bug_suite_plaintes='';
$g_default_bug_deja_vict='';
$g_default_bug_vict_enfce='';
$g_default_bug_contacte='';
$g_default_bug_note_general='';
	...
	/**
	 * @todo Unused
	 * @global int $g_default_email_on_motif_contact
	 */
	$g_default_email_on_motif_nvvenue	=0;

	/**
	 * 'any'
	 * @global int $g_default_email_on_new_minimum_sexe
	 */
	$g_default_email_on_new_minimum_sexe		= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_assigned_minimum_sexe
	 */
	$g_default_email_on_assigned_minimum_sexe	= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_feedback_minimum_sexe
	 */
	$g_default_email_on_feedback_minimum_sexe	= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_resolved_minimum_sexe
	 */
	$g_default_email_on_resolved_minimum_sexe	= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_closed_minimum_sexe
	 */
	$g_default_email_on_closed_minimum_sexe		= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_reopened_minimum_sexe
	 */
	$g_default_email_on_reopened_minimum_sexe	= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_bugnote_minimum_sexe
	 */
	$g_default_email_on_bugnote_minimum_sexe	= OFF;

	/**
	 * 'any'
	 * @global int $g_default_email_on_status_minimum_sexe
	 */
	$g_default_email_on_status_minimum_sexe		= OFF;

	/**
	 * @todo Unused
	 * @global int $g_default_email_on_motif_contact_minimum_sexe
	 */
	$g_default_email_on_motif_nvvenue_minimum_sexe	= OFF;
	 ...
	 * of reporters based on the sexe of bugs. Higher multipliers will
	 * result in an increase in reporter effectiveness.
	 * @global array $g_sexe_multipliers
	 */
	$g_sexe_multipliers = array( FEATURE => 1,
	                                 TRIVIAL => 2,
	                                 TEXT    => 3,
	                                 TWEAK   => 2,
	                                 MINOR   => 5,
...
'note_general'
	 ...
	 */
	$g_handle_bug_threshold			= MANAGER;
	...
	$g_db_table['bugnote_reponse_table']				= 'bugnote_reponse_table';
	...
	/**
	 *
	 * @global string $g_priorite_enum_string
	 */
	$g_motif_nvvenue_enum_string				= '0:N/A,20:violenceconjugale,30:pbtravail,40:demandeinfo,50:dossierinstit,60:recherche,70:sympathisante,80:autreviolence,90:autrepb,100:autre';
	/**
	 *
	 * @global string $g_sexe_enum_string
	 */
	$g_sexe_enum_string				= '10:femme,20:homme';

	/**
	 *
	 * @global string $g_type_contact_enum_string
	 */
	$g_type_contact_rep_enum_string		= $g_type_contact_enum_string		= '10:sur place,20:courrier,30:telephone';
	...
	$g_status_enum_string				= '10:new,20:feedback,50:assigne,90:closed';
	...
	/**
	 *
	 * nouveaux champs $g_champ_enum_string
	 */
	 $g_aide_soc_fin_enum_string = '6:Don caisse-solidarite, 1:Aide-expatriation, 2:Domiciliation-courrier, 3:Contact-banques, 4:Contact-associations,5:Redaction-courrier';
	 $g_aide_alim_enum_string = '5:Fourneau, 1:Secours-adventiste, 2:Secours-catholique, 3:St-Vincent-Paul, 4:Boutique-sociale-Foyal';
	 $g_demarch_enum_string = '5:assistante-sociale, 1:CAF, 2:CGSS, 3:Prefecture, 4:Mairie, 6:ASSOKA, 7:Accompagnement autre';
	 $g_sante_enum_string = '7:Medecin-ville, 1:Urgences, 2:Service-psychotraumatisme, 3:CMP, 4:Psychologue-psychotherapeute, 5:Ateliers-collectifs-internes, 6:Ateliers collectifs-externes';
	 $g_assis_jur_enum_string = '8:Accompagnement-gendarmerie-police, 1:Accompagnement-tribunal, 2:Avocate-reseau-ufm-cabinet, 3:Aide-constitution-dossier, 4:Notaire-reseau-UFM, 5:Syndicats, 6:JAF, 7:Service-aide-victimes, 9:Avocate-reseau-ufm-s-place';
	 $g_heberg_enum_string = '4:Urgence, 1:Programme, 2:Logement-social, 3:Logement-prive';
	 $g_aide_enf_enum_string = '2:Accompagnement-psychologique, 1:Problemes-scolaires';
	 $g_aide_prof_enum_string = '3:Aide-dossier-pro, 1:Pole-emploi, 2:Aide-stage-formation';
	 $g_temps_enum_string = '0:aucun, 15:15min, 30:30min, 45:45min, 60:1h, 120:2h, 180:3h, 240:4h';
	 
	 
	 $g_accompagn_enum_string = '0:N/A,1:Ecoute (I),2:Reponse a laccueil';
	 $g_bes_vio_enum_string = '9:Aide juridique,1:Aide psychologique,2:Demande de renseignements,3:Divorce,4:Expatriation,5:M&eacute;diation familiale,6:Protection physique,7:SéparSéparation,8:autre';
	$g_bes_soc_enum_string = '6:Acc&egrave;s aux droits ,1:Aide alimentaire ,2:Aide demarches administratives,3:Aide financi&egrave;re,4:R&eacute;daction de courrier,5:Recherche emploi-formation,6:Autre';
	$g_attente_enum_string          = '0:aucune,1:sur place,2:rappel t&eacute;l&eacute;phonique';
	$g_nationalite_enum_string          = '0:France,1:Afghanistan,2:Afrique du Sud,3:Albanie,4:Alg&amp;eacute;rie,5:Allemagne,6:Andorre,7:Angola,8:Anguilla,9:Antarctique,10:Antigua-et-Barbuda,11:Antilles n&amp;eacute;erlandaises,12:Arabie saoudite,13:Argentine,14:Arm&amp;eacute;nie,15:Aruba,16:Australie,17:Autriche,18:Azerba&amp;iuml;djan,19:Bahamas,20:Bahre&amp;iuml;n,21:Bangladesh,22:Barbade,23:Belgique,24:Belize,25:Bermudes,26:Bhoutan,27:Bolivie,28:Bosnie-Herz&amp;eacute;govine,29:Botswana,30:Brun&amp;eacute;i Darussalam,31:Br&amp;eacute;sil,32:Bulgarie,33:Burkina Faso,34:Burundi,35:B&amp;eacute;larus,36:B&amp;eacute;nin,37:Cambodge,38:Cameroun,39:Canada,40:Cap-Vert,41:Chili,42:Chine,43:Chypre,44:Colombie,45:Comores,46:Congo,47:Cor&amp;eacute;e du Nord,48:Cor&amp;eacute;e du Sud,49:Costa Rica,50:Croatie,51:Cuba,52:C&amp;ocirc;te d&rsquo;Ivoire,53:Danemark,54:Djibouti,55:Dominique,56:El Salvador,57:Espagne,58:Estonie,59:Fidji,60:Finlande,62:Gabon,63:Gambie,64:Ghana,65:Gibraltar,66:Grenade,67:Groenland,68:Gr&amp;egrave;ce,69:Guadeloupe,70:Guam,71:Guatemala,72:Guernesey,73:Guin&amp;eacute;e,74:Guin&amp;eacute;e &amp;eacute;quatoriale,75:Guin&amp;eacute;e-Bissau,76:Guyana,77:Guyane fran&amp;ccedil;aise,78:G&amp;eacute;orgie,79:G&amp;eacute;orgie du Sud et les &amp;Icirc;les Sandwich du Sud,80:Ha&amp;iuml;ti,81:Honduras,82:Hongrie,83:Inde,84:Indon&amp;eacute;sie,85:Irak,86:Iran,87:Irlande,88:Islande,89:Isra&amp;euml;l,90:Italie,91:Jama&amp;iuml;que,92:Japon,93:Jersey,94:Jordanie,95:Kazakhstan,96:Kenya,97:Kirghizistan,98:Kiribati,99:Kowe&amp;iuml;t,100:Laos,101:Lesotho,102:Lettonie,103:Liban,104:Libye,105:Lib&amp;eacute;ria,106:Liechtenstein,107:Lituanie,108:Luxembourg,109:Mac&amp;eacute;doine,110:Madagascar,111:Malaisie,112:Malawi,113:Maldives,114:Mali,115:Malte,116:Maroc,117:Martinique,118:Maurice,119:Mauritanie,120:Mayotte,121:Mexique,122:Moldavie,123:Monaco,124:Mongolie,125:Montserrat,126:Mont&amp;eacute;n&amp;eacute;gro,127:Mozambique,128:Myanmar,129:Namibie,130:Nauru,131:Nicaragua,132:Niger,133:Nig&amp;eacute;ria,134:Niue,135:Norv&amp;egrave;ge,136:Nouvelle-Cal&amp;eacute;donie,137:Nouvelle-Z&amp;eacute;lande,138:N&amp;eacute;pal,139:Oman,140:Ouganda,141:Ouzb&amp;eacute;kistan,142:Pakistan,143:Palaos,144:Panama,145:Papouasie-Nouvelle-Guin&amp;eacute;e,146:Paraguay,147:Pays-Bas,148:Philippines,149:Pitcairn,150:Pologne,151:Polyn&amp;eacute;sie fran&amp;ccedil;aise,152:Porto Rico,153:Portugal,154:P&amp;eacute;rou,155:Qatar,156:R.A.S. chinoise de Hong Kong,157:R.A.S. chinoise de Macao,158:Roumanie,159:Royaume-Uni,160:Russie,161:Rwanda,162:R&amp;eacute;publique centrafricaine,163:R&amp;eacute;publique dominicaine,164:R&amp;eacute;publique d&amp;eacute;mocratique du Congo,165:R&amp;eacute;publique tch&amp;egrave;que,166:R&amp;eacute;union,167:Sahara occidental,168:Saint-Barth&amp;eacute;l&amp;eacute;my,169:Saint-Kitts-et-Nevis,170:Saint-Marin,171:Saint-Martin,172:Saint-Pierre-et-Miquelon,173:Saint-Vincent-et-les Grenadines,174:Sainte-H&amp;eacute;l&amp;egrave;ne,175:Sainte-Lucie,176:Samoa,177:Samoa am&amp;eacute;ricaines,178:Sao Tom&amp;eacute;-et-Principe,179:Serbie,180:Serbie-et-Mont&amp;eacute;n&amp;eacute;gro,181:Seychelles,182:Sierra Leone,183:Singapour,184:Slovaquie,185:Slov&amp;eacute;nie,186:Somalie,187:Soudan,188:Sri Lanka,189:Suisse,190:Suriname,191:Su&amp;egrave;de,192:Svalbard et &amp;Icirc;le Jan Mayen,193:Swaziland,194:Syrie,195:S&amp;eacute;n&amp;eacute;gal,196:Tadjikistan,197:Tanzanie,198:Ta&amp;iuml;wan,199:Tchad,200:Terres australes fran&amp;ccedil;aises,201:Territoire britannique de l&amp;apos;oc&amp;eacute;an Indien,202:Territoire palestinien,203:Tha&amp;iuml;lande,204:Timor oriental,205:Togo,206:Tokelau,207:Tonga,208:Trinit&amp;eacute;-et-Tobago,209:Tunisie,210:Turkm&amp;eacute;nistan,211:Turquie,212:Tuvalu,213:Ukraine,214:Uruguay,215:Vanuatu,216:Venezuela,217:Vi&ecirc;t Nam,218:Wallis-et-Futuna,219:Y&amp;eacute;men,220:Zambie,221:Zimbabwe,222:r&amp;eacute;gion ind&amp;eacute;termin&amp;eacute;e,223:eacute;gypte,224:eacute;mirats arabes unis,225:eacute;quateur,226:eacute;rythr&amp;eacute;e,227:eacute;tat de la Cit&amp;eacute; du Vatican,228:eacute;tats f&amp;eacute;d&amp;eacute;r&amp;eacute;s de Micron&amp;eacute;sie,229:eacute;tats-Unis,230:eacute;thiopie,231:Icirc;le Bouvet,232:Icirc;le Christmas,233:Icirc;le Norfolk,234:Icirc;le de Man,235:Icirc;les Ca&amp;iuml;mans,236:Icirc;les Cocos - Keeling,237:Icirc;les Cook,238:Icirc;les F&amp;eacute;ro&amp;eacute;,239:Icirc;les Heard et MacDonald,240:Icirc;les Malouines,241:Icirc;les Mariannes du Nord,242:Icirc;les Marshall,243:Icirc;les Mineures &amp;eacute;loign&amp;eacute;es des &amp;eacute;tats-Unis,244:Icirc;les Salomon,245:Icirc;les Turks et Ca&amp;iuml;ques,246:Icirc;les Vierges britanniques,247:Icirc;les Vierges des &amp;eacute;tats-Unis,248:Icirc;les &Aring;land,249:Saint-Domingue';
	$g_orig_orient_enum_string          = '13:115, 1:A.D.I., 2:assistante sociale, 3:autre association, 4:corps medical/struct hosp., 5:DIECCTE , 6:gendarmerie , 7:medecine du travail, 8:pole emploi , 9:police, 10:relation personnelle/ami(e), 14:spontan&eacute;e, 11:syndicat, 12:autre';
	$g_connu_assoc_enum_string          = '0:N/A , 1:entourage familial , 2:medias , 3:prof med/ social , 4:collegues , 5:ami(es)';
	$g_nom_logem_enum_string          = '0:N/A, 1:M., 2:Mme, 3:Mr et Mme, 4:Parents/ami(e)s, 5:SDF';
	$g_type_logem_enum_string          = '0:Aucun, 1:Locataire (social), 2:Locataire (priv&eacute;), 3:Propri&eacute;taire, 4:H&eacute;berg&eacute;e';
	$g_matrim_enum_string = $g_matrim_ant_enum_string          = '8:C&eacute;libataire, 1:Mari&eacute;e, 2:Divorc&eacute;e, 3:Veuve, 4:Union libre, 5:PACS, 6:S&eacute;par&eacute;e, 7:En instance de divorce';
	$g_enf_pere_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_enf_recon_enum_string          = '0:N/A, 1:Aucun, 2:Une partie, 3:Tous';
	$g_sit_prof_enum_string          = '0: N/A, 1:Salari&eacute;e, 2:Ch&ocirc;mage, 3:Femme/M&egrave;re au foyer, 4:Retrait&eacute;e, 5:Etudiante , 6:En formation, 7:A son compte, 8:En stage , 9:Autre';
	$g_niv_scolr_enum_string          = '0:Aucun, 1:Primaire, 2:Secondaire, 3:Coll&egrave;ge, 4:CAP/BEP, 5:Lyc&eacute;e, 6:Bac, 7:Et. sup&eacute;rieures';
	$g_cddcdi_enum_string          = '0:N/A, 1:CDD, 2:CDI';
	$g_typ_contrat_enum_string          = '0:Aucun, 1:Adulte relais, 2:CAE, 3:Contrat d&apos;avenir, 4:Droit commun, 5:Autre';
	$g_secteur_activ_enum_string          = '0:Aucun, 1:Primaire, 2:Secondaire, 3:Tertiaire';
	$g_type_ent_enum_string          = '0:N/A, 1:Association, 2:Monde politique, 3:Priv&eacute;, 4:Public Col locale, 5:Public Etat, 6:Sportif';
	$g_csp_enum_string          = '0:Aucun, 1:Agricultrice, 2:Artisane-commerçante, 3:Ouvri&egrave;re, 4:Employ&eacute;e, 5:Cadre, 6:Pers. de direction, 7:Profession lib&eacute;rale';
	$g_prestations_enum_string          = '11:All. Logmt , 1:All.fam., 2:A.A.H , 3:Al Parent Isol&eacute;, 4:Assedic, 5:RMI, 6:A.E.S (al enf handic), 7:Al Soutien Fam., 8:RSA, 9:APED, 10:Autre';
	$g_mere_victime_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_plaintes_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_plaintes_gend_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_maincour_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_deja_vict_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_vict_enfce_enum_string          = '0:N/A, 1:Oui, 2:Non';
	$g_contacte_enum_string          = '0:N/A , 1:Avocat(e), 2:M&eacute;decin du travail, 3:Prud&apos;hommes, 4:Syndicats, 5:CDMT, 6:CFDT, 7:CGTM-FSM, 8:DIECCTE, 9:FO, 10:SE, 11:UGTM, 12:Autre';
	$g_nb_plaintes_enum_string = '';
	$g_nb_plaintesko_enum_string = '';
	$g_nb_plaintesgend_enum_string = '';
	$g_nb_plainteskogend_enum_string = '';
	$g_nb_maincour_enum_string = '';
	$g_suite_plaintes_enum_string = '';
	$g_note_general_enum_string = '';
	
	/**
	 *
	 * problemes $g_champ_enum_string
	 */
	$g_dur_violence_enum_string = '0:N/A,1:moins d&apos;1 an,2:1 &agrave; 3 ans,3:3 &agrave; 5ans,4:5 &agrave; 10ans,5: + de 10ans';
	$g_lieu_violence_enum_string = '3:dans le couple, 1:au travail, 2:autre';
	$g_nat_vio_cpl_enum_string = '0:Aucun,15:Violence sexuelle,1:Harc&egrave;lement sexuel,2:Viol,3:Violence physique,4:Agression verbale,5:Menaces verbales,6:Menaces avec objet,7:Menaces de mort,8:Violence &eacute;conomique,9:Violence psy/harc&egrave;lement moral,10:Exclusion du domicile,11:D&eacute;gradation de biens,12:Vol d&rsquo;effets personnels,13:S&eacute;questration,14:Autre';
	$g_enf_temoin_cpl_enum_string = '0:N/A,2:oui,3:non,4:NSP';
	$g_enf_vio_cpl_enum_string = '0:N/A,2:oui,3:non,4:NSP';
	#$g_comm_cpl_enum_string = '';
	$g_cond_trav_enum_string = '0:Aucun,15:Absence de t&acirc;ches,2:Baisse de notation/Refus de promotion,3:Critiques exag&eacute;r&eacute;es,4:Non acc&egrave;s aux outils de travail/D&eacute;t&eacute;rioration du poste de travail,5:Pouss&eacute;e à la faute/D&eacute;mission,6:R&eacute;tention d&apos;information,7:Refus de l&apos;application des droits,8:Surcharge de travail/Conitions impossibles &agrave; executer,9:T&acirc;ches sans rapport avec le profil/dangereuses,10:Autre probl&egrave;me';
	$g_isol_trav_enum_string = '1:Non communication normale,2:Isolement physique,3:Refus d&apos;entretien,4:Autre probl&egrave;me';
	$g_dign_trav_enum_string = '1:Discr&eacute;dit,2:Humiliations,3:Mensonges sur la personne,4:Moqueries sur le physique,5:Propos et gestes m&eacute;prisants,6:Autre';
	$g_vio_trav_enum_string = '1:Agressions verbales/injures/insultes,2:D&eacute;t&eacute;rioration d&apos;effets personnels,3:Harc&egrave;lement sexuel,4:harc&egrave;lement t&eacute;l&eacute;ph, courrier, physique,5:Menace physique,6:Menace avec objet ,7:Menace de mort,8:Menace verbale,9:Violence physique,10:Violence sexuelle,11:Viol,12:autre probl&egrave;me ';
	$g_juri_trav_enum_string = '1:Contrat de travail,2:D&eacute;claration sociale,3:Paiement salaires,4:Respect des horaires,5:Remise de document de fin de contrat,6:Autre probl&egrave;me';
	$g_domaine_enum_string = '0:N/A,2:Civil,3:P&eacute;nal';
	#$g_nom_vio_enum_string = '';
	#$g_prenom_vio_enum_string = '';
	#$g_age_vio_enum_string = '';
	$g_sexe_vio_enum_string = '0:N/A,2:Homme,3:Femme';
	$g_adresse_vio_enum_string = '0:N/A,2:M&ecirc;me,3:Autre';
	#$g_emploi_vio_enum_string = '';
	#$g_ressources_vio_enum_string = '';
	$g_secteur_vio_enum_string = '0:Aucun,1:Primaire,2:Secondaire,3:Tertiaire';
	$g_csp_vio_enum_string = $g_csp_enum_string;
	$g_lien_vict_vio_enum_string = '0:Aucun,2:Ami,3:Coll&egrave;gue,4:Concubin,5:Collaborateur,6:Mari,7:Ex-mari,8:Ex-concubin,9:Ex-ami,10:P&egrave;re du ou des enfants,11:Enfant,12:Patron,13:Sup&eacute;rieur hi&eacute;rarchique,14:Propri&eacute;taire,15:Voisin,16:Responsable de stage/formation,17:Autre';
	$g_vict_enf_vio_enum_string = '0:N/A,2:oui,3:non,4:NSP';;
	$g_mere_vict_vio_enum_string = '0:N/A,2:oui,3:non,4:NSP';;
	$g_pb_vio_enum_string = '1:Toxicomanie,2:Alcoolisme,3:Incarc&eacute;r&eacute;,4:D&eacute;s&eacute;quilibre mental m&eacute;dicalement connu,5:Autre,6:Pas de probl&egrave;me connu';
	#$g_comm_vio_enum_string = '';
	$g_cons_phys_enum_string = '1:Fatigue,2:Insomnies/cauchemars,3:Maladie,4:Perte/prise de poids,5:Pertes de m&eacute;moire,6:Autres troubles psychosomatiques';
	$g_cons_psy_enum_string = '1:D&eacute;pression,2:Perte de confiance,3:Peur,4:Stress/anxi&eacute;t&eacute;';
	$g_cons_trav_enum_string = '1:Arr&ecirc;ts maladie,2:CLM/CLD,3:D&eacute;mission,4:Inaptitude au travail';
	$g_cons_soc_enum_string = '1:Divorce/s&eacute;paration (violences au travail),2:Refus de vie sociale/enfermement';
	#$g_cons_comm_enum_string = '';
	 ...
	 */
	$g_css_include_file				= 'css/view.css';
	 ...
	 * for the profile related fields (i.e. nom, os, os build)
