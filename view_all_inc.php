<?php
	...
	if( ( $t_filter_position & FILTER_POSITION_TOP ) == FILTER_POSITION_TOP ) {
			echo '<div class="form_description"><h2>Crit&egrave;res de recherche</h2></div>';
...
echo '<div class="form_description"><h2>R&eacute;sultats</h2></div>';?>
...
?>
			...
			<input type="submit"  value="<?php echo lang_get( 'ok' ); ?>" />
<?php
		} else {
			echo '&#160;';
		}
